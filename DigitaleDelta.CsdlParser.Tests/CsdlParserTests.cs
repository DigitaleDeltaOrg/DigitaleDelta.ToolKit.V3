...
namespace DigitaleDelta.CsdlParser.Tests
{
  public class CsdlParserTests
  {
    ...
    public void ComplexType_PropertiesWithAllAttributesInitializedCorrectly()
    {
      ...
      // Test the first property with all attributes
      ...
      // Test the second property with Nullable=false
      ...
      // Test the third property with MaxLength
      var zipProp = complexType.Properties[2];
      Assert.Equal("ZipCode", zipProp.Name);

      // Test the fourth property with Precision and Scale
    ...
    public void EntityContainer_GetEntityType_EntityTypeNameIsRequired()
    {
      ...
      bool result = CsdlParser.TryParse(csdlContent, out _, out string? error);
      Assert.False(result);
    ...
    {
      // Arrange
      const string validXmlButInvalidCsdl = """
                                            <?xml version="1.0" encoding="utf-8"?>
                                            <root>
                                              <child>
    ...
    {
      // Arrange
      const string xmlWithMissingNamespace = """
                                             <?xml version="1.0" encoding="utf-8"?>
                                             <Edmx Version="4.0">
                                               <DataServices>
                                                 <Schema Namespace="ODataDemo">
