...
public class ODataToSqlConverterTests
{
    ...
    {
        // Arrange
        var map = new ODataToSqlMap { ODataPropertyName = "Name", Query = "ProductName", EdmType = "Edm.String", ColumnName = "ProductName" };
    ...
    private static ODataFilterProcessor SetupProcessor()
    {
        ...
        var processor = new ODataFilterProcessor(GetFunctionMaps(), GetPropertyMaps());
    ...
    private static Dictionary<string, ODataFunctionMap> GetFunctionMaps()
    {
        var map = new List<ODataFunctionMap>
        {
            new()
            {
        ...
        return map.ToDictionary(a => a.ODataFunctionName, StringComparer.OrdinalIgnoreCase);
    }

    private static Dictionary<string, ODataToSqlMap> GetPropertyMaps()
    {
        var map = new List<ODataToSqlMap>
        {
            new() { ODataPropertyName = "Name", Query = "name", EdmType = "Edm.String", ColumnName = "name"},
    ...
    public void TryConvertFilterToSql_SimpleComparison_ReturnsCorrectSql()
    {
        ...
        // Act
        var success = processor.TryProcessFilter("$filter=Name eq '123'",  out var sqlResult, out var error);
    ...
    public void TryConvertFilterToSql_IncorrectComparison_ReturnsFalse()
    {
        ...
        // Act
        var success = processor.TryProcessFilter("$filter=Name bla '123'",  out var sqlResult, out var error);
    ...
    public void TryConvertFilterToSql_SimpleCorrectComparisonWithBugsInCsdl_ReturnsFalse()
    {
        ...
        // Act
        var success = processor.TryProcessFilter("$filter=Blurp eq '123'",  out var sqlResult, out var error);
    ...
    public void TryConvertFilterToSql_WithoutFilter_ReturnsTrue()
    {
        ...
        // Act
        var success = processor.TryProcessFilter(string.Empty, out var sqlResult, out var error);
    ...
    public void TryConvertFilterToSql_FunctionTest_ReturnsTrue()
    {
        ...
        // Act
        var success = processor.TryProcessFilter("$filter=startswith(Name, '123')",out var sqlResult, out var error);
    ...
    public void TryProcessFilter_ConverterFailsToConvertToSql_ReturnsFalse()
    {
        ...
        // Act
        var success = processor.TryProcessFilter(filterString, out var sqlResult, out var error);
    ...
    public void TryValidateFilter_WithComplexTypeWithIncorrectEntityType_ReturnsFalse()
    {
        ...
        var success = validator.TryValidate(filter.Context, out error);
