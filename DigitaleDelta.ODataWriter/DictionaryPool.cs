...
public sealed class DictionaryPool<TKey, TValue>(int initialCapacity = 32, int maxPoolSize = 100) where TKey : notnull
{
    ...
    /// <summary>
    /// Gets the current count of dictionaries in the pool.
    /// </summary>
    /// <remarks>
    /// The value reflects the number of dictionaries currently available in the pool for reuse.
    /// It is incremented when a dictionary is returned to the pool and decremented when a dictionary
